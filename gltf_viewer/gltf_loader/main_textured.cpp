...
int main(int argc, char *argv[])
{
    ...
    // ------------------------------------
    Shader ourShader("gltf_loader/shaders/texture.vs", "gltf_loader/shaders/texture.fs");
    ...
    glBufferData(GL_ARRAY_BUFFER, color_array_size, color_array, GL_STATIC_DRAW);
